...
const values = [
  ...
  },
  {
    ...
    description:
      'We don\'t just hand over keys. We make sure every guest has everything they need before they even ask. The little details are what make a stay unforgettable.',
  },
  {
    title: 'Owner Partnership',
    description:
      'We treat every property as if it were our own. Owners trust us with something valuable — and we take that responsibility seriously.',
  },
];
    ...
    <>
      ...
      >
        ...
        <p className="font-sans text-lg text-[#c8c8c8] max-w-2xl mx-auto text-center leading-relaxed">
          We started Solar Living because we believed Istria deserved better — a boutique approach to hospitality that puts guests and owners first.
        </p>
      </section>
          ...
          <div className="md:w-1/2 space-y-6">
            <div>
              ...
              <h2 className="font-serif text-3xl text-white mb-6">
                A Boutique Company with High Standards.
              </h2>
            </div>
