...
export const metadata: Metadata = {
  ...
  description:
    'Full-service management for property owners in Umag, Istria. Photography, listings, guest communication, cleaning, dynamic pricing and reporting.',
  robots: 'index, follow',
...
const ownersJsonLd = {
  ...
  description:
    'Full-service holiday rental management in Umag, Croatia. Includes professional photography, multi-platform listings, guest communication, cleaning coordination, dynamic pricing and monthly reporting.',
